"""
Django settings for testapiautosetting_136317 project.
...
ROOT_URLCONF = 'testapiautosetting_136317.urls'
...
WSGI_APPLICATION = 'testapiautosetting_136317.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "TestAPIAutoSettingspq60n Support <support@testapiautosetting-136317.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapiautosetting_136317 API",
    "DESCRIPTION": "API documentation for testapiautosetting_136317 App",
    "VERSION": "v1",
}
